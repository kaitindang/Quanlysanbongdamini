...
<body>
    <div class="topnav" id="myTopnav">
        ...
        <a class="active" href="thongke.php" style="text-decoration:none"><i class="fas fa-chart-line"></i>Doanh thu</a>
        <a href="khachhang.php" style="text-decoration:none"><i class="fa fa-users"></i>Khách hàng</a>
        <a href="index.php" style="text-decoration:none"><i class="fa fa-home"></i>Trang chủ</a>
